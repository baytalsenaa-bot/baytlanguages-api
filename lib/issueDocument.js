...
// Used by the admin panel (section 13) and, for one-time CLI issuing, by scripts/issue-document.js.
const fs = require("fs");
 ...
 * @returns {Promise<{id: number, reference: string, token: string, verifyUrl: string, qrFilePath: string}>}
 */
